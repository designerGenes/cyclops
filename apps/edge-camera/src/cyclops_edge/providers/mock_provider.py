...
class MockCameraProvider(CameraProvider):
    ...
    def next_frame(self) -> bytes:
        ...
        draw.rectangle((0, 0, width, 48), fill=(accent, 120, 180))
        draw.text((16, 12), self.camera_name, fill=(255, 255, 255))
        draw.text((16, 68), now.isoformat(), fill=(240, 240, 240))
        draw.text(
            (16, 96),
            f"{width}x{height} fps={self._settings.frame_rate} q={self._settings.jpeg_quality}",
            fill=(210, 210, 210),
        )
